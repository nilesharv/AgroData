...
<div id="form-wrap">
 ...
 <h4>All India</h4>
  ...
  <tr>
			...
			<a href="menuallindia.jsp?table=<%=res.getString("TABLE_NAME")%>" target="_self"><%=new String(new String(res.getString("TABLE_NAME")).replaceAll("_"," ")).toUpperCase()%> !</a> </br>
  ...
  <a href="state.jsp" target="_self">Go through Statewise !</a> </br>
